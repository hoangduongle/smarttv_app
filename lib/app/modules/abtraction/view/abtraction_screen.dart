...
class _AbtractionScreenState extends State<AbtractionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AbtractionController>(
      builder: (controller) {
        final Stream<List<AbtractionContent>> abtractionContentsStream =
            controller.abtractionStream();

        return StreamBuilder<List<AbtractionContent>>(
            stream: abtractionContentsStream,
            builder: (context, snapshot) {
              List<AbtractionContent>? listPromotions = [];
              if (snapshot.hasData) {
