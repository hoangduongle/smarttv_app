          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                      ...
                      children: [
                        TextButton(
                          style: ButtonStyle(
                              ...
                              fixedSize:
                                  MaterialStateProperty.all(Size(130.w, 0.h)),
                          ...
                          child: Text(
                            ...
                            style: AppStyles.h4.copyWith(
                                color: controller.numberSelected.toInt() == 0
                                    ? AppColors.black
                                    : AppColors.white,
                        ...
                        TextButton(
                          ...
                          child: Text(
                            ...
                            style: AppStyles.h4.copyWith(
                                //title
                                color: controller.numberSelected.toInt() == 1
                                    ? AppColors.black
                                    : AppColors.white,
                                fontWeight: FontWeight.bold,
                                fontSize: 14.sp),
                ...
                controller.mayjorFood.isEmpty && controller.mayjorDrink.isEmpty
                    ? Expanded(
                        child: Center(
                            child:
                                Lottie.asset(AppAssets.loading, width: 300.w)))
                    : Expanded(
                        child: Padding(
